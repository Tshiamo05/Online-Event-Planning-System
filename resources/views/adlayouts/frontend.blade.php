...
<head>
  ...
  <!-- MDB -->
  <link rel="stylesheet" href={{assets{'assets/css/mdb.min.css'}}} />
  <!-- Custom styles -->
  <link rel="stylesheet" href={{assets{'assets/css/mdb.min.css'}}} />
...
<body>
  ...
  <!--Main layout-->
  <!-- MDB -->
  <script type="text/javascript" src={{assets{'assets/js/mdb.min.js'}}}></script>
  <!-- Custom scripts -->
  <script type="text/javascript" src={{assers{'assets/js/admin.js'}}}></script>
